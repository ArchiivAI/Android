    ...
    AlertDialog(
        ...
        text = {
            Column(
                ...
                BasicTextField(
                    value = newRoleName,
                    onValueChange = { onRoleNameChange(it) },
                    modifier = Modifier
                        .fillMaxWidth()
                    ...
                    decorationBox = { innerTextField ->
                        if (newRoleName.isEmpty()) {
                            Text(
                                text = "Untitled Role", // Updated hint
                                fontSize = 16.sp,
                                color = Color.Gray
                            )
                        }
...
@Composable
fun RenameRoleDialogPreview(modifier: Modifier = Modifier) {
    RenameRoleDialog("", {}, {},"",{})
}