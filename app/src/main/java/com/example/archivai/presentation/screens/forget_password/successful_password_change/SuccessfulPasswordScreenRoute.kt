...
fun NavGraphBuilder.successfulPasswordScreenRoute(navController: NavController){

    composable <Screens.SuccessfulPassword> {
        SuccessfulPasswordChange(navController)
    }
