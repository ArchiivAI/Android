...
data class FolderUiState(
    ...
    val isFileOptionsBottomSheetVisible: Boolean = false,
    val isUploading: Boolean = false,
    val selectedFiles: List<java.io.File> = emptyList(),
    val capturedImage: java.io.File? = null,
    val isUploadConfirmationBottomSheetVisible : Boolean = false,
